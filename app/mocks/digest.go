...
func (m *MockDigestDaoInterface) GetLastDigest(userId string) (models.SendAlarmDigest, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetLastDigest", userId)
	ret0, _ := ret[0].(models.SendAlarmDigest)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockDigestDaoInterface) InsertDigest(digest models.SendAlarmDigest) error {
	m.ctrl.T.Helper()
